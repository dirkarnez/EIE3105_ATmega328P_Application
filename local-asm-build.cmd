...
avrasm2.exe -fI -o "main.hex"  -m "main.map"  -l "main.lss"  -S "main.tmp" -W+ie -I"%DOWNLOADS_DIR%\Downloads\Atmel.ATmega_DFP.2.1.506\avrasm\inc" -im328Pdef.inc -d "main.obj"  "main.asm"
pause
